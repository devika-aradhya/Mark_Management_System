...
<head>
    ...
    <style>
       ...
       body {
    background-color: #f0f2f5; /* A very light gray, softer than bright white */
...
.card-header {
    background-color: #4CAF50; /* A pleasant green for headers */
...
.btn-primary {
    background-color: #007bff; /* Standard Bootstrap blue for primary buttons */
    border-color: #007bff;
...
.alert {
    border-radius: 8px;
    /* You might want to define specific alert colors like: */
    /* background-color: #d4edda; border-color: #c3e6cb; color: #155724; for success */
}

.nav-pills .nav-link.active {
    background-color: #007bff; /* Matches primary button color for active nav links */
}
