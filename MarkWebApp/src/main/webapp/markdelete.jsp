...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-9">
            <div class="card">
                <div class="card-header">Delete Student Mark</div>
                <div class="card-body">
                    ...
                    <!-- Search Form -->
                    <div class="card mb-3">
                        <div class="card-header bg-warning text-dark">Search Student by ID</div>
                        <div class="card-body">
...
<script>
    // Only run if elements exist to avoid JS errors
